      ...
      <div className="hero">
        <div className="asd">
          <section className="intro">
            <h1 className="intro__title">We develop Projects</h1>
            <p class="intro__subtitle">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga
              nihil sunt distinctio animi non explicabo voluptate nobis pariatur
              tempora dolore assumenda rem sit, quas id facilis officiis autem
              praesentium soluta.
            </p>
          ...
          <div className="intro_spec">
            <div className="intro_info">
              <h3>93%</h3>
              <p>placed within 8 months of graduation</p>
            </div>
            <div className="intro_info">
              <h3>11 LPA</h3>
